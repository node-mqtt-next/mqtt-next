![](RackMultipart20231203-1-fis8x7_html_9dca90a05598d6da.jpg)
...
[1.8.2 MQTT v5.0 20](#_Toc3901018)
...
[3.1.2.11.5 Topic Alias Maximum 37](#_Toc3901051)
...
[3.2.2.3.4 Maximum QoS 48](#_Toc3901084)
...
[3.3.2.3.8 Subscription Identifier 59](#_Toc3901117)
...
[3.6.4 PUBREL Actions 69](#_Toc3901150)
...
[3.10.2.1.1 Property Length 80](#_Toc3901183)
...
[3.14.4 DISCONNECT Actions 89](#_Toc3901216)
...
[4.8.1 Non‑shared Subscriptions 101](#_Toc3901249)
...
[5.4.12.2 Secured network communication profile 117](#_Toc3901282)
...
## 2.1Structure of an MQTT Control Packet
...
#### 3.1.2.12Variable Header non-normative example
...
##### 3.1.3.2.4Message Expiry Interval
...
1. The Server MUST perform the processing of Clean Start that is described in [section 3.1.2.4](#_Clean_Start)[MQTT-3.1.4-4].
...
##### 3.2.2.3.15Response Information
...
##### 3.2.2.3.17Authentication Method
...
_Figure 3‑8 – PUBLISH packet Fixed Header_
...
#### 3.3.2.3PUBLISH Properties

##### 3.3.2.3.1Property Length
...
##### 3.3.2.3.8Subscription Identifier
...
3. If the receiver does not already have a mapping for this Topic Alias
  1. If the packet has a zero length Topic Name field it is a Protocol Error and the receiver uses DISCONNECT with Reason Code of 0x82 (Protocol Error) as described in [section 4.13](#S4_13_Errors).
...
#### 3.4.2.2PUBACK Properties

##### 3.4.2.2.1Property Length
...
## 3.5PUBREC – Publish received (QoS 2 delivery part 1)

A PUBREC packet is the response to a PUBLISH packet with QoS 2. It is the second packet of the QoS 2 protocol exchange.

### 3.5.1PUBREC Fixed Header

_Figure 3‑12 - PUBREC packet Fixed Header_
...
#### 3.5.2.2PUBREC Properties

##### 3.5.2.2.1Property Length
...
## 3.6PUBREL – Publish release (QoS 2 delivery part 2)

A PUBREL packet is the response to a PUBREC packet. It is the third packet of the QoS 2 protocol exchange.

### 3.6.1PUBREL Fixed Header

_Figure 3‑14 – PUBREL packet Fixed Header_
...
#### 3.6.2.2PUBREL Properties

##### 3.6.2.2.1Property Length
...
## 3.7PUBCOMP – Publish complete (QoS 2 delivery part 3)

The PUBCOMP packet is the response to a PUBREL packet. It is the fourth and final packet of the QoS 2 protocol exchange.

### 3.7.1PUBCOMP Fixed Header

_Figure 3‑16 – PUBCOMP packet Fixed Header_
...
#### 3.7.2.2PUBCOMP Properties

##### 3.7.2.2.1Property Length
...
### 3.8.1SUBSCRIBE Fixed Header

_Figure 3‑18 SUBSCRIBE packet Fixed Header_
...
### 3.8.2SUBSCRIBE Variable Header
...
## 3.9SUBACK – Subscribe acknowledgement
...
### 3.9.1SUBACK Fixed Header

_Figure 3‑22 - SUBACK Packet Fixed Header_
...
## 3.10UNSUBSCRIBE – Unsubscribe request

An UNSUBSCRIBE packet is sent by the Client to the Server, to unsubscribe from topics.

### 3.10.1UNSUBSCRIBE Fixed Header
...
### 3.10.2UNSUBSCRIBE Variable Header
...
## 3.11UNSUBACK – Unsubscribe acknowledgement

The UNSUBACK packet is sent by the Server to the Client to confirm receipt of an UNSUBSCRIBE packet.

### 3.11.1UNSUBACK Fixed Header
...
### 3.11.2UNSUBACK Variable Header
...
_Table 3‑9 - Unsubscribe Reason Codes_
...
### 3.12.1PINGREQ Fixed Header

_Figure 3.33 – PINGREQ packet Fixed Header_
...
### 3.14.2DISCONNECT Variable Header
...
#### 3.14.2.1Disconnect Reason Code
...
#### 3.14.2.2DISCONNECT Properties

##### 3.14.2.2.1Property Length
...
##### 3.14.2.2.2Session Expiry Interval
...
### 3.14.3DISCONNECT Payload

The DISCONNECT packet has no Payload.

### 3.14.4DISCONNECT Actions
...
## 3.15AUTH – Authentication exchange
...
#### 3.15.2.1Authenticate Reason Code
...
### 4.1.2Session State non-normative examples
...
## 4.3Quality of Service levels and protocol flows
...
### 4.3.1QoS 0: At most once delivery
...
### 4.3.2QoS 1: At least once delivery
...
- MUST treat the PUBLISH packet as "unacknowledged" until it has received the corresponding PUBREC packet from the receiver [MQTT-4.3.3-3]. Refer to [section 4.4](#_Figure_4.3_%E2%80%93) for a discussion of unacknowledged messages.
...
## 4.7Topic Names and Topic Filters

### 4.7.1Topic wildcards
...
### 4.10.1Basic Request Response (non-normative)
...
### 4.10.2Determining a Response Topic value (non-normative)
...
### 4.13.1Malformed Packet and Protocol Errors
...
## 5.2MQTT solutions: security and certification
...
## 5.3Lightweight crytography and constrained devices
...
### 5.4.1Authentication of Clients by the Server
...
MQTT v5.0 provides an enhanced authentication mechanism as described in [section 4.12](#_Enhanced_authentication). Using this requires support for it in both the Client and Server.
...
Where TLS [[RFC5246]](#RFC5246) is used, TLS Certificates sent from the Client can be used by the Server to authenticate the Client.
...
### 5.4.2Authorization of Clients by the Server
...
### 5.4.3Authentication of the Server by the Client
...
### 5.4.4Integrity of Application Messages and MQTT Control Packets
...
### 5.4.5Privacy of Application Messages and MQTT Control Packets
...
### 5.4.7Detecting compromise of Clients and Servers

Client and Server implementations using TLS [[RFC5246]](#RFC5246)should provide capabilities to ensure that any TLS certificates provided when initiating a TLSconnection are associated with the hostname of the Client connecting or Server being connected to.

Client and Server implementations using TLS can choose to provide capabilities to check Certificate Revocation Lists (CRLs [[RFC5280]](#RFC5280)) and Online Certificate Status Protocol (OSCP**)** [[RFC6960]](#RFC6960) **t** o prevent revoked certificates from being used.
...
### 5.4.8Detecting abnormal behaviors
...
### 5.4.9Handling of Disallowed Unicode code points
...
#### 5.4.9.1Considerations for the use of Disallowed Unicode code points
...
#### 5.4.9.2Interactions between Publishers and Subscribers
...
### 5.4.10Other security considerations

If Client or Server TLS certificates are lost or it is considered that they might be compromised they should be revoked (utilizing CRLs [[RFC5280]](#RFC5280) and/or OSCP [[RFC6960]](#RFC6960)).
...
#### 5.4.12.1Clear communication profile
...
#### 5.4.12.2Secured network communication profile
...
#### 5.4.12.3Secured transport profile
...
#### 5.4.12.4Industry specific security profiles
...
## 7.1Conformance clauses

### 7.1.1MQTT Server conformance clause
...
### 7.1.2MQTT Client conformance clause
...
1.
# Mandatory normative statement (non-normative)

This Appendix is non-normative and is provided as a convenient summary of the numbered conformance statements found in the main body of this document. Refer to [Chapter 7](#_Conformance) for a definitive list of conformance requirements.
...
Standards Track Work Product Copyright © OASIS Open 2019. All Rights Reserved. Page 9 of 85